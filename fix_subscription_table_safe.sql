-- إصلاح آمن لجدول user_subscriptions (يحافظ على البيانات)
-- هذا الملف يحل مشكلة خطأ 406 مع الحفاظ على المشتركين الحاليين
...
-- 10. إضافة بيانات للمستخدم الحالي إذا لم يكن موجوداً
...
BEGIN
    ...
    RAISE NOTICE 'Safe database fix completed successfully!';
