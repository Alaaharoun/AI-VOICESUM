@echo off
echo ========================================
echo    إصلاح آمن للويب - يحافظ على البيانات
echo ========================================
echo.
...
echo [2/4] تطبيق إصلاح قاعدة البيانات الآمن...
echo.
echo ⚠️  يرجى تطبيق ملف fix_subscription_table_safe.sql في Supabase Dashboard
echo.
echo 1. اذهب إلى Supabase Dashboard > SQL Editor
echo 2. انسخ محتوى ملف fix_subscription_table_safe.sql
echo 3. الصق الكود واضغط Run
echo 4. انتظر حتى تظهر "Safe database fix completed successfully!"
