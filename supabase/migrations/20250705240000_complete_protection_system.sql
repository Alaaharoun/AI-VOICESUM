-- =============================================================================
-- Complete Protection System: Signup + Free Trial + Free Minutes + Admin Powers
-- Migration: 20250705240000_complete_protection_system.sql
-- =============================================================================
-- This migration fixes signup errors AND protects both free trial and free minutes from reuse
-- Also provides comprehensive admin powers for system management
...
-- =============================================================================
-- PART 3: Create Free Minutes Protection System
-- =============================================================================

-- Create a table to track email addresses that have received free minutes
...
-- Enable RLS on free_minutes_usage table
ALTER TABLE free_minutes_usage ENABLE ROW LEVEL SECURITY;

-- Create policies for free_minutes_usage (only superadmins can manage this)
...
-- =============================================================================
-- PART 4: Create Protection Functions
-- =============================================================================
...
-- =============================================================================
-- PART 7: Admin Functions for Free Minutes Management
-- =============================================================================
...
SELECT 
  'Complete protection system activated' as status,
